export default function FloatingButtons() {
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
      ...
      <a
        href="tel:+923057121111"
        aria-label="Call Now"
        data-cursor="link"
        className="w-[52px] h-[52px] rounded-full bg-gold-gradient bg-[length:200%_100%] text-black flex items-center justify-center shadow-gold hover:bg-right transition-all duration-500"
      >
        <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M6.6 10.8c1.3 2.6 3.3 4.6 5.9 5.9l2-2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.5.6.5 0 1 .5 1 1V20c0 .5-.5 1-1 1C10.6 21 3 13.4 3 4c0-.5.5-1 1-1h3.9c.5 0 1 .5 1 1 0 1.2.2 2.4.6 3.5.1.4 0 .8-.3 1.1l-2 2.2Z"/></svg>
      </a>
      <a
        ...
        data-cursor="link"
        className="w-[52px] h-[52px] rounded-full border border-gold/50 bg-black/80 backdrop-blur text-gold flex items-center justify-center hover:bg-gold hover:text-black transition-all duration-300"
      >
