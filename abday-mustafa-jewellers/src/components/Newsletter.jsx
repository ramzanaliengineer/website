  ...
  return (
    <section className="section-pad bg-obsidian-2 border-y border-gold/10">
      <div className="container-lux flex flex-col items-center text-center gap-6 max-w-xl mx-auto">
        ...
        <h2 className="heading-serif text-3xl sm:text-4xl text-ivory">Join our private collector's list</h2>
        <p className="text-ivory/50 text-sm">Be the first to know about new collections, gemstone arrivals and exclusive previews.</p>
        <form onSubmit={submit} className="flex flex-col sm:flex-row gap-3 w-full mt-2">
          <input
            ...
            className="flex-1 bg-transparent border border-gold/30 px-5 py-3.5 text-sm text-ivory placeholder:text-ivory/30 focus:border-gold outline-none"
          />
