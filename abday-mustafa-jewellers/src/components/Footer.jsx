...
export default function Footer() {
  return (
    <footer className="relative bg-black border-t border-gold/15 pt-20 pb-8 overflow-hidden">
      ...
      <div className="container-lux relative grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-1">
          <Link to="/" className="flex items-center gap-3 mb-5">
            <span className="w-11 h-11 border border-gold/60 rounded-full flex items-center justify-center text-gold heading-serif text-lg">AM</span>
            <span className="flex flex-col leading-none">
              <span className="heading-serif text-xl text-ivory">Abday Mustafa</span>
              <span className="eyebrow text-[10px]">Gems &amp; Jewellers</span>
            </span>
          </Link>
          <p className="text-ivory/50 text-sm leading-relaxed mb-5">
        ...
        <div>
          ...
          <ul className="space-y-3">
            {quickLinks.map((l) => (
              <li key={l.to}>
                <Link to={l.to} className="text-sm text-ivory/60 hover:text-gold transition-colors duration-300">
                  {l.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          >
            <div className="absolute inset-0 bg-[linear-gradient(135deg,#120e09,#1a1410)] flex items-center justify-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-4 inline-block text-sm text-ivory/60 hover:text-gold transition-colors duration-300"
          >
      ...
      <div className="container-lux flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-ivory/40">
