      ...
      <section className="pb-24 sm:pb-32 bg-pearl">
        <div className="container-lux grid lg:grid-cols-2 gap-16">
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5 mt-8">
                <input
                  ...
                  className="bg-transparent border border-gold/25 px-5 py-3.5 text-sm text-ink placeholder:text-ink/30 focus:border-gold outline-none"
                />
                <input
                  required
                  name="phone"
                ...
                <textarea
                  ...
                  className="bg-transparent border border-gold/25 px-5 py-3.5 text-sm text-ink placeholder:text-ink/30 focus:border-gold outline-none resize-none"
                />
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="flex flex-col gap-8">
            ...
            >
              <div className="absolute inset-0 bg-[linear-gradient(135deg,#F3ECDF,#EAE0CC)]" />
