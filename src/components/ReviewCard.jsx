  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <span className="text-[10px] text-ink/30 tracking-widest2 uppercase">Google Review</span>
      </div>
      <p className="text-ink/70 text-sm leading-relaxed italic">&ldquo;{review.text}&rdquo;</p>
      <div className="flex items-center gap-3 mt-auto pt-2 border-t border-gold/10">
        ...
        <div>
          ...
          <p className="text-ink/40 text-xs">{review.location}</p>
        </div>
      </div>
    </motion.div>
  )
