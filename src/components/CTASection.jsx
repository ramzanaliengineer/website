...
export default function CTASection() {
  return (
    <section className="relative section-pad bg-gradient-to-b from-pearl via-beige to-pearl text-center overflow-hidden">
      ...
      >
        ...
        <h2 className="heading-serif text-3xl sm:text-5xl text-ink max-w-2xl leading-tight">
          Begin your legacy with a piece crafted just for you
        </h2>
        <p className="text-ink/60 max-w-lg text-sm sm:text-base">
