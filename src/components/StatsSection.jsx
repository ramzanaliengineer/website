...
export default function StatsSection() {
  return (
    <section className="relative bg-pearl-dark border-y border-gold/10 py-16">
      <div className="container-lux grid grid-cols-2 md:grid-cols-4 gap-10">
        {stats.map((s, i) => (
          ...
          >
            ...
            <p className="text-ink/50 text-[11px] sm:text-xs tracking-widest2 uppercase mt-2">{s.label}</p>
          </motion.div>
        ))}
      </div>
    </section>
