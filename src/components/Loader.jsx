      ...
      {loading && (
        ...
        >
          <motion.div
            ...
            className="w-20 h-20 rounded-full border border-gold/50 flex items-center justify-center text-gold mb-6 p-5"
          >
          ...
          <div className="mt-8 w-40 h-[1px] bg-beige overflow-hidden">
            <motion.div
